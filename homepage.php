      ...
      <div id="center">
         ...
         <div class="card-deck">
            <div class="card">
               ...
               <form action"" method="post" class="card-footer">
                  <input type="submit" value="Add to cart" name="peterPan">
               </form>
            ...
            <div class="card">
               ...
               <input type="submit" class="card-footer" value="Add to cart" name="aliceInWonderland">
            </div>
            ...
            <div class="card">
               ...
               <form action"" method="post" class="card-footer">
                  <input type="submit" class="card-footer" value="Add to cart" name="harryPotter">
               </form>
            </div>
            ...
            <div class="card">
               ...
               <form action"" method="post" class="card-footer">
                  <input type="submit" class="card-footer" value="Add to cart" name="wizardOfOz">
               </form
            </div>
         </div>  
         ...
         <div class="card-deck">
            <div class="card">
               ...
               <input type="submit" class="card-footer" value="Add to cart" name="hobbit">
            </div>
            ...
            <div class="card">
               ...
               <input type="submit" class="card-footer" value="Add to cart" name="twilight">
            </div>
            ...
            <div class="card">
               ...
               <input type="submit" class="card-footer" value="Add to cart" name="xMen101">
            </div>
            ...
            <div class="card">
               ...
               <form action"" method="post" class="card-footer">
                  <input type="submit" class="card-footer" value="Add to cart" name="summerFalls">
               </form>
            </div>
         </div> 
      </div>
